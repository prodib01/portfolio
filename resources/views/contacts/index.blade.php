                    ...
                    <div class="p-6">
                        ...
                        <div class="space-y-4">
                            ...
                            <div class="flex space-x-4 mt-6">
                                @if($user->github_url)
                                    <a href="{{ $user->github_url }}" target="_blank" class="text-gray-600 hover:text-gray-900">
                                ...
                                @if($user->linkedin_url)
                                    <a href="{{ $user->linkedin_url }}" target="_blank" class="text-gray-600 hover:text-gray-900">
                                        <svg class="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
